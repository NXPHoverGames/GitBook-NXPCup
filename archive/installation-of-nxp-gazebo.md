...
![Expected output for \`chmod\`](<../.gitbook/assets/image (3).png>)
...
![Expected output for \`cat \~/.bashrc\` and \`source \~/.bashrc\`](<../.gitbook/assets/image (22).png>)
...
![Expected \~/.bashrc after adding lines](<../.gitbook/assets/image (29).png>)
...
![Expected output for building PX4 binary](<../.gitbook/assets/image (30).png>)
...
![NXP Cup Simulation](<../.gitbook/assets/image (31).png>)
